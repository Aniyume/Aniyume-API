...
@section('title', 'Создание аниме - АниЮм Админ')
...
<div class="page-header">
    <h1 class="page-title">➕ Создание нового аниме</h1>
</div>

@if($errors->any())
    <div class="error-alert" style="position: relative;">
    ...
    <form action="{{ route('admin.anime.store') }}" method="POST">
        ...
        <div class="form-grid">
            <div class="form-group full">
                ...
                <input type="text" name="title" value="{{ old('title') }}" required placeholder="Введите название аниме..."
                       class="form-input">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status" required class="form-select">
                    ...
                    <option value="paused" {{ old('status') === 'paused' ? 'selected' : '' }}>⏸️ На паузе</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="type" required class="form-select">
                    ...
                    <option value="movie" {{ old('type') === 'movie' ? 'selected' : '' }}>🎞️ Фильм</option>
            ...
            <div class="form-group">
                ...
                <input type="number" name="year" value="{{ old('year') }}" min="1900" max="2100"
                       placeholder="{{ date('Y') }}" class="form-input">
            </div>
