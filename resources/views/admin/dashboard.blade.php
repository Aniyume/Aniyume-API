...
<style>
    ...
    .stat-icon { width: 48px; height: 48px; background: #f0fdfa; border-radius: 0.75rem; display: flex; align-items: center; justify-content: center; color: #00f2ea; font-size: 1.5rem; }
    ...
    .content-card { background: #ffffff; border: 1px solid #f0f2f5; border-radius: 1.25rem; padding: 2rem; box-shadow: 0 2px 12px rgba(0,0,0,0.02); }
    ...
    .anime-list { display: flex; flex-direction: column; gap: 1rem; }
    .anime-item { display: flex; align-items: center; justify-content: between; background: #fcfdfe; border: 1px solid #f0f2f5; border-radius: 0.75rem; padding: 1rem; transition: all 0.2s ease; cursor: pointer; }
    .anime-item:hover { background: #f4f4f4; }
    ...
    .import-list { display: flex; flex-direction: column; gap: 1rem; }
    .import-item { background: #fcfdfe; border: 1px solid #f0f2f5; border-radius: 0.75rem; padding: 1rem; }
    .import-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; }
    .import-type { color: #6f767e; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; }
    ...
    .import-status.running { background: #fffbeb; color: #d97706; }
    .import-body { display: flex; justify-content: space-between; align-items: end; }
    .import-info { display: flex; flex-direction: column; }
    .import-processed { color: #1a1d1f; font-size: 0.9rem; font-weight: 700; margin-bottom: 0.25rem; }
