...
body {
    ...
    .sidebar-logo:hover .sidebar-logo-icon { transform: rotate(-10deg) scale(1.1); }
    ...
    .sidebar-nav { flex: 1; padding: 0 1.25rem; display: flex; flex-direction: column; gap: 0.4rem; overflow-y: auto; }
    ...
    .sidebar-link i { width: 18px; height: 18px; margin-right: 12px; transition: transform 0.3s ease; }
    .sidebar-link .nav-label { display: flex; align-items: center; }

    .sidebar-link:hover { background: rgba(255,255,255,0.05); color: #FFFFFF; padding-left: 1.5rem; }
    .sidebar-link:hover i { transform: scale(1.2); color: #2EC4B6; }
    ...
    .sidebar-logout:hover { background: #ff4d4d; color: #fff; transform: translateY(-2px); }
    ...
    .main-user:hover .main-user-avatar { border-color: #2EC4B6; transform: scale(1.05); }

    .content-body { padding: 3rem; flex: 1; animation: fadeIn 0.5s ease; }
    ...
    @media (max-width: 1024px) {
        .sidebar { width: 85px; }
        .sidebar-logo-text-wrap, .nav-text, .sidebar-logout span, .sidebar-logo-sub { display: none; }
    ...
    @media (max-width: 768px) {
        ...
        .sidebar-logo-text-wrap, .nav-text, .sidebar-logout span, .sidebar-logo-sub { display: block; }
        .sidebar-logo { justify-content: flex-start; padding: 2.5rem 2rem; }
        .sidebar-link { justify-content: flex-start; padding: 1rem 1.25rem; }
        .sidebar-link i { margin-right: 12px; }

        .main-header { height: 80px; padding: 0 1.5rem; }
        .main-title h1 { font-size: 1.2rem; }
        .main-user-info { display: none; }
        .content-body { padding: 1.5rem; }

        .main-user-avatar { width: 40px; height: 40px; font-size: 1rem; border-radius: 12px; }
    }
</style>
</head>
<body>
